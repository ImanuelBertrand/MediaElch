...
protected:
    ...
    /// \details Watches ui->set: an editable QComboBox is the focus proxy of its own line
    ///          edit, so the focus events arrive at the combo box and not at the line edit.
